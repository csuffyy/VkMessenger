...
namespace VkData.Account.Types
{
    ...
    {
        public VkCallbacks(Action onAuthenticating,
            Action
                <
                    IAuthenticationService
                        <Message, User, LongPollServerResponse, VkApi, LongPollServerSettings, Chat,
                            MessagesGetHistoryParams, Photo, StickerSize, PhotoSize>> onAuthenticationFailure,
            Action onAuthorized, Action<Exception> onAuthorizationException, Action onApiException)
            : base(onAuthenticating, onAuthenticationFailure, onAuthorized, onAuthorizationException, onApiException)
        {
        }
        ...
        public VkCallbacks(
            AccountCallbacks
                <Message, User, LongPollServerResponse, VkApi, LongPollServerSettings, Chat, MessagesGetHistoryParams,
                    Photo, StickerSize, PhotoSize> callbacks) : base(callbacks)
        {
        }
    }
}